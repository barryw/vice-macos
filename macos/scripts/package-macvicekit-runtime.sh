...
ZIP_PATH="$DIST_DIR/MacVICERuntime-$VERSION-arm64.framework.zip"
LATEST_ZIP_PATH="$DIST_DIR/MacVICERuntime-latest-arm64.framework.zip"
...
create_framework_skeleton() {
    ...
    rm -rf "$WORK_DIR" "$ZIP_PATH" "$LATEST_ZIP_PATH"
