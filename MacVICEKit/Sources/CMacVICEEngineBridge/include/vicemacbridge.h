/*
 * vicemacbridge.h - MacVICE runtime ABI used by MacVICEKit.
 *
 * Keep this header in sync with vice/src/arch/macos/vicemacbridge.h. It is
 * vendored here so MacVICEKit remains buildable as an independent Swift
 * package while the VICE implementation stays in the upstream-tracking tree.
 */
